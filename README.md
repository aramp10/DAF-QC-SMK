...
3. Backup files provided by Brian:
   ...
   ```
   See the [bkup](https://github.com/aramp10/DAF-QC-SMK/tree/main/bkup) folder for the files generated by the above procedure:
   
   * `DAF-QC-SMK-SCC.txt`: README with detailed instructions (provided for future reference)
   * `pyabpoa-1.5.4-cp310-cp310-linux_x86_64.whl`: wheel file for the pipeline
   * `python.yaml`: YAML file for the pipeline
